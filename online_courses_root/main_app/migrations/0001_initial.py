...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('solution', models.FileField(upload_to='uploads/solutions/')),
                ('homework', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='main_app.homework')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solution', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='main_app.solution')),
            ],
        ),
        migrations.CreateModel(
            name='Lecture',
        ...
        migrations.AddField(
            model_name='homework',
            name='lecture',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lecture', to='main_app.lecture'),
        ),
    ]
